...
core.use([Autoplay, Navigation, Pagination, Scrollbar]);
function slider() {
  ...
  var bestPriceSlider = new core('.best__price-slider', {
    breakpointsInverse: true,
    slidesPerView: 2,
    spaceBetween: 8,
    speed: 1000,
  ...
  var cardImgSlider = new core('.card__img-slider', {
    breakpointsInverse: true,
    slidesPerView: 1,
    spaceBetween: 25,
    loop: true,
  ...
  var vkSlider = new core('.new-world-vk__slider', {
    breakpointsInverse: true,
    slidesPerView: 1,
    spaceBetween: 25,
    loop: true,
  ...
  var shopSlider = new core('.main-shops__slider', {
    breakpointsInverse: true,
    slidesPerView: 1,
    spaceBetween: 25,
    loop: true,
  ...
  var raitingSlider = new core('.main-raitings__slider', {
    breakpointsInverse: true,
    slidesPerView: 1,
    spaceBetween: 25,
    loop: true,
  ...
  var productCardAddSliderCount = $('.product__slider--add').slick('getSlick').slideCount;
...
function header() {
  var burgerBtn = document.querySelector('.b-header__burger-switcher');
  var burgerMenu = document.querySelector('.burger__menu');
  var burgerMenuClose = document.querySelector('.burger__city-close');
  var botMenuCatalog = document.querySelector('.bot__menu-item.catalog');
  var burgerCatalog = document.querySelector('.burger__catalog');
  var burgerAccordCatalog = document.querySelectorAll('.accordion.accordion-burger.accordion-burger-catalog');
  var body = document.querySelector('body');
  var burgerCatalogTopBtns = document.querySelectorAll('.burger__catalog-top button');
  var headerSearchBtn = document.querySelector('.b-header__btn-search');
  var searchGoods = document.querySelector('.search__goods.city__search');
  var searchGoodsClose = document.querySelector('.city__search-title.search__goods-title button');
  if (searchGoodsClose) {
    searchGoodsClose.addEventListener('click', function () {
  ...
  if (burgerAccordCatalog) {
    burgerAccordCatalog.forEach(function (item) {
  ...
  if (burgerCatalogTopBtns) {
    burgerCatalogTopBtns.forEach(function (item) {
      item.addEventListener('click', function () {
  ...
  if (botMenuCatalog) {
    botMenuCatalog.addEventListener('click', function () {
      burgerCatalog.classList.toggle('active');
      botMenuCatalog.classList.toggle('active');
      body.classList.toggle('lock');
    });
  }
  var deskSearch = document.querySelector('.b-header-desk-search input');
  var deskSearchRes = document.querySelector('.b-header-desk-search-result');
  if (deskSearch) {
  ...
  var headerCatalogBtn = document.querySelector('.b-header-desk-catalog-btn');
  var headerCatalog = document.querySelector('.b-header-desk-catalog');
  if (headerCatalogBtn) {
  ...
  var headerCatalogShowMore = document.querySelectorAll('.b-header-catalog-content-item-block--showmore');
  if (headerCatalogShowMore) {
    headerCatalogShowMore.forEach(function (item) {
      item.addEventListener('click', function () {
...
;// CONCATENATED MODULE: ./src/scripts/components/cityChoose/index.js
function cityChoose() {
  var cityChoose = document.querySelector('.city__choose');
  var body = document.querySelector('body');
  if (cityChoose) {
    var makeCityChooseVisible = function makeCityChooseVisible() {
    ...
    var cityChooseCLose = document.querySelector('.city__choose-close');
    cityChooseCLose.addEventListener('click', function () {
      cityChoose.classList.remove('visible');
      body.classList.remove('city-block');
    });
    var cityChooseAccept = document.querySelector('.city__choose-btn.btn');
    cityChooseAccept.addEventListener('click', function () {
      cityChoose.classList.remove('visible');
      body.classList.remove('city-block');
      document.querySelector('.bot__menu').classList.remove('lock');
    });
    var cityChooseBtn = document.querySelector('.city__choose-btn.btn--white');
    var citySearch = document.querySelector('.city__search');
    var citySearchClose = document.querySelector('.city__search-title button');
    var burgerCityLink = document.querySelectorAll('.js-city-link');
    if (cityChooseBtn) {
      cityChooseBtn.addEventListener('click', function () {
    ...
    if (citySearchClose) {
      citySearchClose.addEventListener('click', function () {
    ...
    if (burgerCityLink) {
      burgerCityLink.forEach(function (item) {
        item.addEventListener('click', function () {
          citySearch.classList.add('open');
...
;// CONCATENATED MODULE: ./src/scripts/components/card/index.js
function card() {
  var addToFavouriteBtn = document.querySelectorAll('.card__favourite');
  if (addToFavouriteBtn) {
    addToFavouriteBtn.forEach(function (item) {
      item.addEventListener('click', function () {
        item.classList.toggle('active');
      });
    });
  }
  var cardAddBtn = document.querySelectorAll('.card__add-btn.btn');
  if (cardAddBtn) {
    cardAddBtn.forEach(function (item) {
      item.addEventListener('click', function () {
...
;// CONCATENATED MODULE: ./src/scripts/components/about/index.js
function about() {
  if (document.querySelector('.main-about')) {
    var playVideoBtn = document.querySelector('.main-about__video-plug-play');
    var videoPLug = document.querySelector('.main-about__video-plug');
    var video = document.querySelector('.main-about__video iframe');
    var videoId = video.getAttribute('src').slice(30);
    var videoDurationWrp = document.querySelector('.main-about__video-duration');
    var apiKey = 'AIzaSyASReS-jCAjxrKxznV4TgOZVX1D37yVvSA';
    var url = 'https://www.googleapis.com/youtube/v3/videos?id=' + videoId + '&key=' + apiKey + '&part=contentDetails';
    var videoDurationMins = document.querySelector('.main-about__video-duration-mins');
    var videoDurationSecs = document.querySelector('.main-about__video-duration-secs');
    var aboutText = document.querySelector('.main-about__text-wrapper');
    var aboutTextControls = document.querySelector('.main-about__text-controls');
    var aboutTextBtn = document.querySelector('.main-about__text-btn');
    ...
    if (aboutTextBtn) {
      aboutTextBtn.addEventListener('click', function () {
...
;// CONCATENATED MODULE: ./src/scripts/components/scrollToTop/index.js
function scrollToTop_scrollTop() {
...
;// CONCATENATED MODULE: ./src/scripts/components/productsCards/index.js
...
;// CONCATENATED MODULE: ./src/scripts/components/catalog/index.js
function catalog() {
  ...
  var accordionContentLinksInnerWrapper = document.querySelectorAll('.catalog__filters-inner-container');
  if (accordionContentLinksInnerWrapper) {
    accordionContentLinksInnerWrapper.forEach(function (item) {
      var height = item.scrollHeight;
      var showMoreBtn = item.nextElementSibling;
      if (height > 192) {
  ...
  var catalogBtnMain = document.querySelector('.catalog__filter-btn--main');
  var catalogFilterClose = document.querySelector('.catalog__filters-close');
  if (catalogBtnMain) {
    catalogBtnMain.addEventListener('click', function () {
  ...
  if (catalogFilterClose) {
    catalogFilterClose.addEventListener('click', function () {
      document.querySelector('.catalog__filters-wrapper').classList.remove('active');
      document.querySelector('body').style.overflow = 'visible';
      document.querySelector('.bot__menu').style.opacity = 1;
      document.querySelector('.bot__menu').style.visibility = 'visible';
...
;// CONCATENATED MODULE: ./src/scripts/components/priceRangeSlider/index.js

function PriceRangeSlider() {
  var stepsSlider = document.getElementById('slider-price');
  var input0 = document.getElementById('input_min');
  var input1 = document.getElementById('input_max');
...
;// CONCATENATED MODULE: ./src/scripts/components/catalogCheckboxes/index.js
function catalogCheckboxes() {
  ...
  var catalogCheckboxWrappers = document.querySelectorAll('.catalog__checkbox-wrapper');
  if (catalogCheckboxWrappers) {
    catalogCheckboxWrappers.forEach(function (catalogCheckboxWrapper) {
      var parent = catalogCheckboxWrapper.closest('.ac-panel');
      var checkAll = parent.querySelector('.catalog__checkbox-check-all-wrapper');
      var showAll = parent.querySelector('.catalog__checkbox-show-all');
  ...
  var catalogRes = document.querySelector('.filter__result-float');
  var catalogFiltersLinks = document.querySelectorAll('.catalog__filters-inner-container a');
  if (catalogFiltersLinks) {
    catalogFiltersLinks.forEach(function (item) {
      item.addEventListener('click', function () {
        catalogRes.classList.add('visible');
        var height = item.closest('.ac').offsetTop;
        catalogRes.style.top = height + 'px';
      });
    });
  }
  var catalogPriceRange = document.querySelector('.slider-range');
  if (catalogPriceRange) {
    catalogPriceRange.addEventListener('click', function () {
      catalogRes.classList.add('visible');
      var height = catalogPriceRange.closest('.ac').offsetTop;
      catalogRes.style.top = height + 'px';
    });
  }
  var priceInputs = document.querySelectorAll('.filter__price-wrapper input');
  if (priceInputs) {
  ...
  var catalogCheckboxInners = document.querySelectorAll('.catalog__checkbox-wrapper-inner');
  if (catalogCheckboxInners) {
    catalogCheckboxInners.forEach(function (item) {
      item.addEventListener('click', function () {
        catalogRes.classList.add('visible');
        var height = item.closest('.ac').offsetTop;
...
;// CONCATENATED MODULE: ./src/scripts/components/accordionCustom/index.js
function accordionCustom() {
  var accordionBtns = document.querySelectorAll(".accordion__button");
...
;// CONCATENATED MODULE: ./src/scripts/components/product/index.js
function product() {
  var productFavouriteBtn = document.querySelector('.product__favourite-button');
  if (productFavouriteBtn) {
    productFavouriteBtn.addEventListener('click', function () {
      productFavouriteBtn.classList.toggle('active');
    });
  }
  var productBtnCart = document.querySelector('.btn--product-basket');
  if (productBtnCart) {
    productBtnCart.addEventListener('click', function () {
  ...
  var cardShowAllBtn = document.querySelector('.js-card-show-all');
  if (cardShowAllBtn) {
    cardShowAllBtn.addEventListener('click', function () {
      characteristicsScroll('.product__tabs-nav', 1000);
      var tabsButtons = document.querySelectorAll('.product__tabs-nav-btn');
      var tabsContents = document.querySelectorAll('.product__tabs-content-item');
      var characteristicBtn = document.querySelector('.js-product-tab-characteristic');
      var characteristicContent = document.querySelector('.product__tabs-content-item--characteristics');
  ...
  if (innerWidth > 568) {
    var characteristicsList = document.querySelector('.product__tabs-content-item--characteristics');
    var characteristicsItems = document.querySelectorAll('.product__tabs-content-item--characteristics > div');
    if (characteristicsList && characteristicsItems) {
      var length = characteristicsItems.length;
      if (length >= 6) {
...
var accordion_min = __webpack_require__(8171);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.querySelector('.catalog__filter-container')) {
    new (accordion_min_default())('.catalog__filter-container', {
      duration: 400,
      showMultiple: true,
